...
| 5 | "We must polish the native swap. SELL SUCCESS or something — not informative and too primitive" | Trade panel reports a bare status word; no amounts, no tx link, no balance delta | open |
