...
const rows: [string, string, string][] = [
  ...
  ...(PROOF_BURNER_LIVE ? [['ProofBurner (the flywheel)', PROOF_BURNER, 'Collects the PROOF-burn leg from every campaign and can only ever buy $PLAUNCH and send it to the dead address: pons curve before graduation, Uniswap v4 directly after, 0.2 ETH per crank, one crank per block. No owner, no withdraw, no retarget. Anyone can crank.'] as [string, string, string]] : []),
