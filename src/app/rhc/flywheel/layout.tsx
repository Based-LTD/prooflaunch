...
const description = 'Every trade on tokens launched through the flywheel factory will buy and burn $PLAUNCH. Counters, burns per day, which launches feed it and who cranks it — all read from the chain.';
