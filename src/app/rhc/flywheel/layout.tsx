...
const description = 'Every trade on every ProofLaunch token buys and burns $PLAUNCH. Live counters, burns per day, which launches feed it, who cranks it — all read from the chain.';
