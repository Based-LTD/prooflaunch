          ...
          <section className="relative border-2 border-[var(--accent-gold)] bg-[var(--card)] p-6 space-y-4">
            ...
            <div className="space-y-4 pt-2">
              {[
                ...
                { num: '3', title: 'Launch on Pump.fun', desc: 'Once all slots are filled, click "Launch". Genesis slots (1-4) buy first at the best prices. Wave 2 slots (5-8) follow immediately in a second wave.' },
              ].map((step) => (
