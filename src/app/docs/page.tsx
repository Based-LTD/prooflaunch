      ...
      <div className="space-y-6">
          ...
          <>
            ...
            <section className="relative border-2 border-[var(--accent)] bg-[var(--card)] p-6 space-y-4">
              ...
              <p className="text-[var(--foreground)]/80 leading-relaxed">
                ...
                <strong> Meteora</strong>, or <strong>Raydium LaunchLab</strong> as the launchpad,
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
                ...
                <div className="bg-[var(--background)] border-2 border-[var(--border)] p-4 text-center">
                  ...
                  <div className="text-sm text-[var(--muted)] uppercase tracking-wide font-bold">Launch on Pump.fun, Meteora, or LaunchLab</div>
          ...
          <section className="relative border-2 border-[var(--accent)] bg-[var(--card)] p-6 space-y-4">
            ...
            <div className="mt-6 border-l-4 border-[var(--warning)] bg-[var(--background)] p-4 space-y-2">
              ...
              <ul className="text-sm text-[var(--muted)] space-y-1 pl-4">
                ...
                <li>· Trade the coin once on its market (Pump.fun, Meteora, or LaunchLab) — visibility usually triggers within a few minutes of any activity</li>
        ...
        {activeTab === 'creators' && (
          <section className="relative border-2 border-[var(--accent-gold)] bg-[var(--card)] p-6 space-y-4">
            ...
            <div className="space-y-4 pt-2">
              {[
                { num: '1', title: 'Submit Your Token (0.02 SOL)', desc: 'Create your token with name, symbol, description, image, and socials (X, Telegram, Discord, Website, GitHub — GitHub links bake into the on-chain metadata extensions, so wallets and explorers can surface code-shipping devs). Set 2-24 backer slots, a minimum backing amount, and pick your launchpad (Pump.fun, Meteora, or LaunchLab).' },
                ...
                { num: '3', title: 'Launch on Pump.fun, Meteora, or LaunchLab', desc: 'Once all slots are filled, click "Launch" when you\'re ready. Coordinate with whales, time the market, give yourself a runway. The pool waits for you — funded tokens don\'t expire.' },
              ].map((step) => (
        ...
        {activeTab === 'fees' && (
          <>
            ...
            <section className="relative border-2 border-[var(--border)] bg-[var(--card)] p-6 space-y-4">
              ...
              <div className="space-y-3 pt-2">
                {[
                  { label: 'Creation Fee', value: '0.02 SOL', color: 'border-[var(--accent)]', desc: 'One-time fee when submitting a token. Covers token creation on the chosen launchpad (Pump.fun, Meteora, or LaunchLab). Waived for $PROOF holders (≥500k).' },
            ...
            <section className="relative border-2 border-[var(--success)] bg-[var(--card)] p-6 space-y-4">
              ...
              <p className="text-[var(--foreground)]/80 leading-relaxed">
                Pump.fun, Meteora, and LaunchLab all route a percentage of trading volume to the token's
                creator vault (administered by Proof Launch). The protocol routes that vault three ways:
                a pro-rata rebate to genesis backers (hold-weighted), an allocation to platform operations,
                and an allocation to a discretionary $PROOF distribution pool. Creators are eligible for
                the backer rebate only by participating as backers themselves.
              </p>
              <div className="bg-[var(--background)] border-2 border-[var(--border)] p-4 mt-4">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between p-2 bg-[var(--card)]">
                    <span className="text-[var(--muted)]">Launchpad creator fee (Pump.fun 0.5% / Meteora + LaunchLab similar)</span>
          ...
          <>
            <section className="relative border-2 border-[var(--success)] bg-[var(--card)] p-6 space-y-4">
              ...
              <div className="bg-[var(--background)] border-2 border-[var(--border)] p-4 space-y-3">
                ...
                <p className="text-sm text-[var(--muted)]">
                  The 5% platform cut funds token creation on the chosen launchpad (Pump.fun, Meteora,
                  or LaunchLab) and ongoing operations. The other 5% platform-side allocation is routed
                  to a discretionary $PROOF distribution pool. All fee transactions are verifiable on-chain
              ...
              <div className="bg-[var(--background)] border-2 border-[var(--border)] p-4 space-y-3">
                ...
                <ul className="text-sm text-[var(--muted)] space-y-1">
                  ...
                  <li>· Trade them on Pump.fun, Meteora, LaunchLab, or any DEX the moment they arrive</li>
                </ul>
              </div>
