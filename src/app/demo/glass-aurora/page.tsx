...
// DEMO A2 — Glass cards over AURORA gradient drift.
// Same glass cards as /demo/glass, but bg is three blurred radial
// gradient blobs (gold / warm amber / deep amber) slowly drifting
// + scaling on 30-40s loops. Reads as atmospheric, premium — closer
// to Anthropic / Stripe / Vercel territory, no copy of pumptracks.

import Link from 'next/link';
import { AuroraBackground } from '@/components/demo/AuroraBackground';
...
export default function GlassAuroraDemo() {
  return (
    <>
      <AuroraBackground />
