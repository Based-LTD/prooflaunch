...
// DEMO A3 — Glass cards over LIVE ACTIVITY STREAM.
// Same glass cards as /demo/glass, but bg is three columns of (mocked)
// on-chain Proof Launch activity scrolling upward at very low opacity.
// In a real build this subscribes to actual events. The bg literally
// proves the product is alive — uniquely yours, impossible for pumptracks
// or any generic launchpad to copy.

import Link from 'next/link';
import { ActivityStreamBackground } from '@/components/demo/ActivityStreamBackground';
...
export default function GlassStreamDemo() {
  return (
    <>
      <ActivityStreamBackground />
