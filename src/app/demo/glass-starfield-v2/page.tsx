...
import { StarfieldExpensiveBackground } from '@/components/demo/StarfieldExpensiveBackground';
...
export default function GlassStarfieldV2Demo() {
  return (
    <>
      <StarfieldExpensiveBackground />
      ...
      <div className="relative min-h-screen text-white font-mono">
        ...
        <div className="absolute top-3 right-3 text-[10px] font-mono uppercase tracking-widest text-[#ff9d00]/70 z-50">
          DEMO_A6 · STARFIELD V2 (EXPENSIVE)
        </div>
