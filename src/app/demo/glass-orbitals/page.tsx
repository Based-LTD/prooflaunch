...
// DEMO A — Glass-cards-over-particle-field aesthetic.
// Goal: capture the "alive, beautiful" pumptracks feel using
// Proof Launch's gold/amber brand palette. No vaporwave pinks/cyans.
//
// Design moves:
//   • Fixed particle background (canvas-rendered, drifting gold motes)
//   • Glass cards: black @ 40% opacity + backdrop-blur + glowing border
//   • Hover: border intensifies + soft amber glow + slight lift
//   • Subtle pulse on the [LIVE] indicator
//   • Headline gets a soft amber text-shadow for that neon-feel
// Sample content matches the live homepage shape so the comparison
// against /demo/tech is apples-to-apples.

import Link from 'next/link';
import { ThreeOrbitalsBackground } from '@/components/demo/ThreeOrbitalsBackground';
...
export default function GlassOrbitalsDemo() {
  return (
    <>
      <ThreeOrbitalsBackground />
