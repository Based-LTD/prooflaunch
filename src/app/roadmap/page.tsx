...
const BUILDING = [
  ...
  { icon: Shield, title: 'Signature addresses', desc: 'Every campaign (and eventually every token) deployed to a vanity address ending in the PoolLaunch signature — CREATE2 salt-grinding, done invisibly at submit. On Solana it was "…pooL"; the EVM signature is being chosen from the hex alphabet. If the address doesn\'t carry the signature, it didn\'t come from us.' },
