...
const SHIPPED = [
  ...
  { icon: Search, title: 'WalletProof — who is really buying', desc: 'Every trade on the chain\'s launchpad, replayed on-chain. Paste any token: independent buyers vs crew volume vs one-shot wallets vs launch bots, plus the deployer\'s full history. Chain-wide stats show how many "graduations" are manufactured. Counts only — no wallet doxxing.' },
