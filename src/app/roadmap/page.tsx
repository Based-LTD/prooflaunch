...
const SHIPPED = [
  ...
  { icon: Coins, title: 'Backers keep most of the creator tax; 30% burns $PROOF', desc: 'The immutable FeeSplitter routes every launch\u2019s creator tax: 30% buys and burns $PROOF, 10% platform, the rest to backers pro-rata (50% on the default preset, 60% with no coin burn). Sellers forfeit their share into the burn. Pull-based: your share waits in the contract with your name on it; no operator has to be alive for anyone to get paid.' },
