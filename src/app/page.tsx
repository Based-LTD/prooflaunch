...
import { ChainDefault } from '@/components/ChainDefault';
...
export default function Home() {
  ...
  return (
    <div className="space-y-4 sm:space-y-5">
      {/* Fresh visitors land on Robinhood Chain; a remembered SOL choice
          (navbar toggle) keeps them here. Deep links never touched. */}
      <ChainDefault />
