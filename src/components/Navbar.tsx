...
export const Navbar: FC = () => {
  ...
  // Glass mode auto-engages on /demo/* routes so the navbar sits over
  // the demo backgrounds (video, nebula, etc.) without looking like a
  // solid bar punched on top. Translucent + backdrop-blur.
  ...
  return (
    <>
      ...
      <div className={`fixed top-0 left-0 right-0 z-[60] h-6 border-b ${barBg} flex items-center justify-between px-4 text-[10px] font-mono uppercase tracking-widest text-[var(--muted)]`}>
      ...
      {/* Main nav */}
      <nav className={`fixed top-6 left-0 right-0 z-50 border-b ${barBg}`}>
