...
// The pool wallet keypair used to live here as a literal and was committed
// to the public repo on 2026-07-17 (found in the 2026-09-21 safety comb).
// Treat that key as burned. Read it from the environment, never inline.
const POOL_KP_B58 = process.env.LAUNCHLAB_TEST_POOL_KP;
if (!POOL_KP_B58) throw new Error('LAUNCHLAB_TEST_POOL_KP not set');
